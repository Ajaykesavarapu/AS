    ...
    schema: [
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 3,
            "name": post.title,
            "item": `https://www.askreativ.in/blog/${slug}`
          }
        ]
      },
      {
        ...
        "@type": "BlogPosting",
        "headline": post.title,
        "image": post.img.startsWith("http") ? post.img : `${window.location.origin}${post.img}`,
        "datePublished": post.date === "June 2024" ? "2024-06-01" : "2024-07-01",
        "author": {
          "@type": "Organization",
          "name": "ASKreativ"
        },
        "publisher": {
          ...
          "logo": {
            "@type": "ImageObject",
            "url": "https://www.askreativ.in/logo.png"
          }
        },
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": `https://www.askreativ.in/blog/${slug}`
        }
      }
    ]
  });
